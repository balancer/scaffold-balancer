...
exports.MathSol = exports.ALMOST_ONE = exports.FOUR_WAD = exports.TWO_WAD = exports.RAY = exports.WAD = void 0;
const ether_1 = require("./ether");
exports.WAD = 1000000000000000000n;
exports.RAY = 1000000000000000000000000000n;
exports.TWO_WAD = 2000000000000000000n;
exports.FOUR_WAD = 4000000000000000000n;
exports.ALMOST_ONE = (0, ether_1.unsafeFastParseEther)('0.99');
...
class MathSol {
    ...
    static mulUpFixed(a, b) {
        ...
        if (product == 0n) {
            ...
            return (product - 1n) / exports.WAD + 1n;
        }
    }
    ...
    static powUpFixed(x, y, version) {
        if (y === exports.WAD && version !== 1) {
            return x;
        }
        else if (y === exports.TWO_WAD && version !== 1) {
            return this.mulUpFixed(x, x);
        }
        else if (y === exports.FOUR_WAD && version !== 1) {
    ...
    static complementFixed(x) {
        return x < exports.WAD ? exports.WAD - x : 0n;
    }
}
exports.MathSol = MathSol;
