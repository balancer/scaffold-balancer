...
var OnChainPoolDataEnricher = class {
    ...
    return pools.map((pool) => {
      ...
      return {
        ...
        tokens: pool.tokens.sort((a, b) => a.index - b.index).map((token) => {
          return {
            ...token,
            balance: _optionalChain([data, 'optionalAccess', _ => _.balances]) && data.balances.length > 0 ? _viem.formatUnits.call(void 0, 
            ...
            weight: _optionalChain([data, 'optionalAccess', _2 => _2.weights]) ? _viem.formatUnits.call(void 0, data.weights[token.index], 18) : token.weight
          };
        }),
        totalShares: _optionalChain([data, 'optionalAccess', _3 => _3.totalSupply]) ? _viem.formatUnits.call(void 0, data.totalSupply, 18) : pool.totalShares,
        amp: _optionalChain([data, 'optionalAccess', _4 => _4.amp]) ? _viem.formatUnits.call(void 0, data.amp, 3).split(".")[0] : "amp" in pool ? pool.amp : void 0,
        swapFee: _optionalChain([data, 'optionalAccess', _5 => _5.swapFee]) ? _viem.formatUnits.call(void 0, data.swapFee, 18) : pool.swapFee
      };
    });
  }
  ...
  getPoolTokenRate({
    ...
    if (_optionalChain([data, 'optionalAccess', _6 => _6.wrappedTokenRate]) && "wrappedIndex" in pool && pool.wrappedIndex === index) {
      return _viem.formatUnits.call(void 0, data.wrappedTokenRate, 18);
    }
    if (_optionalChain([data, 'optionalAccess', _7 => _7.scalingFactors])) {
      return _viem.formatUnits.call(void 0, data.scalingFactors[index], 18);
    }
...
var SubgraphPoolProvider = class {
  ...
  async getPools(options) {
    ...
    return {
      ...response,
      pools: _optionalChain([response, 'optionalAccess', _8 => _8.pools]) || [],
      syncedToBlockNumber: _optionalChain([response, 'optionalAccess', _9 => _9.syncedToBlockNumber]) || 0n
    };
  }
  async fetchDataFromSubgraph(options) {
    ...
    do {
      ...
      const variables = {
        ...
        ..._optionalChain([options, 'optionalAccess', _10 => _10.block]) ? {
          block: {
  ...
  poolMatchesFilter(pool) {
    ...
    if (_optionalChain([this, 'access', _11 => _11.config, 'access', _12 => _12.poolTypeNotIn, 'optionalAccess', _13 => _13.includes, 'call', _14 => _14(pool.poolType)])) {
      return false;
    }
    if (this.config.poolIdIn && !this.config.poolIdIn.includes(pool.id)) {
      return false;
    }
    if (_optionalChain([this, 'access', _15 => _15.config, 'access', _16 => _16.poolIdNotIn, 'optionalAccess', _17 => _17.includes, 'call', _18 => _18(pool.id)])) {
      return false;
    }
    return true;
  }
...
var PathGraph = class {
  ...
  expandTokenPath({
    ...
    for (let i = 0; i < tokenPath.length - 1; i++) {
      const edge = _optionalChain([this, 'access', _19 => _19.edges, 'access', _20 => _20.get, 'call', _21 => _21(tokenPath[i]), 'optionalAccess', _22 => _22.get, 'call', _23 => _23(tokenPath[i + 1])]);
  ...
  filterVolatilePools(poolAddresses) {
    ...
    for (const poolAddress of poolAddresses) {
      if (_optionalChain([this, 'access', _24 => _24.poolAddressMap, 'access', _25 => _25.get, 'call', _26 => _26(poolAddress), 'optionalAccess', _27 => _27.poolType]) === "Weighted" /* Weighted */) {
...
// src/entities/pools/linear/linearPool.ts
var ONE = _viem.parseEther.call(void 0, "1");
...
var LinearPool = class {
  ...
  swapGivenIn(tokenIn, tokenOut, swapAmount, mutateBalances) {
    ...
    if (output.amount > (_optionalChain([tOut, 'optionalAccess', _28 => _28.amount]) || 0n)) {
      throw new Error("Swap amount exceeds the pool limit");
    }
    if (output.amount < 0n)
  ...
  swapGivenOut(tokenIn, tokenOut, swapAmount, mutateBalances) {
    const { tIn, tOut } = this.getRequiredTokenPair(tokenIn, tokenOut);
    if (swapAmount.amount > (_optionalChain([tOut, 'optionalAccess', _29 => _29.amount]) || 0n)) {
      throw new Error("Swap amount exceeds the pool limit");
    }
    let input;
    if (tokenIn.isEqual(this.mainToken.token)) {
...
var SmartOrderRouter = class {
  ...
  async getCandidatePaths(tokenIn, tokenOut, options) {
    if (!this.isInitialized || _optionalChain([options, 'optionalAccess', _30 => _30.block]) && options.block !== this.blockNumber) {
      await this.fetchAndCachePools(_optionalChain([options, 'optionalAccess', _31 => _31.block]));
    }
    return this.router.getCandidatePaths(
      tokenIn,
      tokenOut,
      this.pools,
      _optionalChain([options, 'optionalAccess', _32 => _32.graphTraversalConfig])
    );
  }
};
...
async function sorGetSwapsWithPools(tokenIn, tokenOut, swapKind, swapAmount, pools, swapOptions) {
  ...
  const candidatePaths = router.getCandidatePaths(
    ...
    tokenOut,
    pools,
    _optionalChain([swapOptions, 'optionalAccess', _33 => _33.graphTraversalConfig])
  );
...
exports.Address = _viem.Address; exports.BALANCER_QUERIES = BALANCER_QUERIES; exports.BALANCER_SOR_QUERIES_ADDRESS = BALANCER_SOR_QUERIES_ADDRESS; exports.ChainId = ChainId; exports.DECIMAL_SCALES = DECIMAL_SCALES; exports.DEFAULT_FUND_MANAGMENT = DEFAULT_FUND_MANAGMENT; exports.DEFAULT_USERDATA = DEFAULT_USERDATA; exports.ETH = ETH; exports.FOUR_WAD = FOUR_WAD; exports.Hex = _viem.Hex; exports.MAX_UINT112 = MAX_UINT112; exports.MathSol = MathSol; exports.NATIVE_ADDRESS = NATIVE_ADDRESS; exports.NATIVE_ASSETS = NATIVE_ASSETS; exports.OnChainPoolDataEnricher = OnChainPoolDataEnricher; exports.PREMINTED_STABLE_BPT = PREMINTED_STABLE_BPT; exports.Path = Path; exports.PathWithAmount = PathWithAmount; exports.PoolType = PoolType; exports.SECONDS_PER_YEAR = SECONDS_PER_YEAR; exports.STELLATE_URLS = STELLATE_URLS; exports.SUBGRAPH_URLS = SUBGRAPH_URLS; exports.SmartOrderRouter = SmartOrderRouter; exports.SubgraphPoolProvider = SubgraphPoolProvider; exports.Swap = Swap; exports.SwapKind = SwapKind; exports.TWO_WAD = TWO_WAD; exports.Token = Token; exports.TokenAmount = TokenAmount; exports.WAD = WAD; exports.ZERO_ADDRESS = ZERO_ADDRESS; exports.abs = abs; exports.checkInputs = checkInputs; exports.getPoolAddress = getPoolAddress; exports.poolHasActualSupply = poolHasActualSupply; exports.poolHasPercentFee = poolHasPercentFee; exports.poolHasVirtualSupply = poolHasVirtualSupply; exports.poolIsLinearPool = poolIsLinearPool; exports.sorGetSwapsWithPools = sorGetSwapsWithPools; exports.sorParseRawPools = sorParseRawPools;
